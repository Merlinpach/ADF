...
export const Sidebar: React.FC<SidebarProps> = ({ sections, activeSection, onLinkClick, isOpen, setIsOpen }) => {
  ...
  return (
    <>
      ...
      <aside className={`fixed top-0 h-full w-64 bg-green-800 text-white shadow-lg flex flex-col z-40 transition-all duration-300 ease-in-out
                       lg:ltr:left-0 lg:rtl:right-0
                       ${isOpen 
                           ? 'ltr:left-0 rtl:right-0' 
                           : 'ltr:-left-64 rtl:-right-64'
                       }`}>
